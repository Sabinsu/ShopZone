    ...
    <section className="py-10 bg-gradient-to-b from-white to-orange-50/30">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {user && tab === 'recommended' && !productId && (
                <p className="text-xs text-gray-400">✨ Personalised by AI based on your activity</p>
              )}
            </div>
          ...
          {/* Tab switcher — only on non-related pages */}
          {!productId && (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {loading
            ...
            : products.slice(0, productId ? 8 : 12).map(p => (
